...
export function separateTimeOfArrival(information) {
  const mutated = structuredClone(information)
  const {timeOfArrival} = mutated
  delete mutated.timeOfArrival
  return [timeOfArrival, {...mutated}]
}
